...
- [x] Dockerfile
- [x] Конвертация FB2 в другой формат (txt, epub, pdf)
- [x] Оглавление и отображение картинок в читалке
...
Для weasyprint нужны системные пакеты: `libpango1.0-0 libgdk-pixbuf2.0-0 libharfbuzz0b fonts-dejavu`
...
- Онлайн-чтение FB2 (кнопка «📖 Read»):
  - Регулировка шрифта, ночной режим, прогресс-бар
  - Оглавление (TOC) — боковая панель с навигацией и подсветкой текущей главы
  - Отображение изображений из FB2
  - Закладки по позиции скролла: метка на прогресс-баре, хранятся в localStorage
  - Кнопки конвертации: ⬇ TXT / ⬇ EPUB / ⬇ PDF
  - Кнопка печати (🖨) / сохранения в PDF через браузер
- Закладки: кнопка ⭐ сохраняет книгу в localStorage браузера
- Конвертация FB2 → TXT, EPUB (с картинками и оглавлением), PDF (требует weasyprint)
